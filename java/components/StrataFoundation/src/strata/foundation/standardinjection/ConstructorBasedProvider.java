    ...
    implements Provider<T>
{
    ...
    private Constructor<? extends T> itsConstructor;
    ...
    get()
    {
        try
        {
            T instance = itsConstructor.newInstance( getArguments() );       
    ...
    getArguments()
    {
        ...
        {
            if ( !itsBindings.hasBinding( identifier ) )
                throw 
                    new IllegalStateException(
                        "Container does not have binding:" + 
                        identifier.toString() );
            
            arguments.add( itsBindings.getInstance( identifier ) );
        }
    ...
    getArgument(Field field)
    {
        ...
        return itsBindings.getInstance( identifier );
    }
