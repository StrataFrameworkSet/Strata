// ##########################################################################
// # File Name:	IParameterizedCommandInvoker.java
// #
 ...
 */
public 
interface IParameterizedCommandInvoker<T>
{
    public void
    setCommand(IParameterizedCommand<T> command);
    
    public void
    setParameter(T parameter);
    
    public IParameterizedCommand<T>
    getCommand();
