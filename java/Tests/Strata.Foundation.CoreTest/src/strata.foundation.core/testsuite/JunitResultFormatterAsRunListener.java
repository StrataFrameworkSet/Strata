...
public
class JunitResultFormatterAsRunListener
    extends RunListener
{
    ...
    @Override
    public void
    testRunStarted(Description description) throws Exception
    {
    }

    @Override
    public void
    testRunFinished(Result result) throws Exception
    {
    }
    ...
    @Override
    public void
    testFinished(Description description) throws Exception
    {
        System.out.flush();
        System.err.flush();
    ...
    @Override
    public void
    testFailure(Failure failure) throws Exception
    {
    ...
    @Override
    public void
    testIgnored(Description description) throws Exception
    {
