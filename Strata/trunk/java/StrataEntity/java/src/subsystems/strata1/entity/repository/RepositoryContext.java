...
interface RepositoryContext
{
	 ...
	 * <code>RepositoryContext</code> that synchronizes access to all
	 * of the <code>RepositoryImp</code>s associated with this 
	 * <code>RepositoryContext</code>.
	 *
	 ...
	 * <code>RepositoryContext</code> that manages the transactions to all
	 * of the <code>RepositoryImp</code>s associated with this
	 * <code>RepositoryContext</code>.
	 * 
