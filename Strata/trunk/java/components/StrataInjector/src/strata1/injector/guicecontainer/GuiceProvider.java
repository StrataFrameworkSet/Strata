 ...
 */
public 
class GuiceProvider<T>
    implements com.google.inject.Provider<T>
{
    private Provider<? extends T> itsAdaptee;
    
    /************************************************************************
     * Creates a new {@code GuiceProvider}. 
     *
     */
    public 
    GuiceProvider(Provider<? extends T> adaptee)
    {
        itsAdaptee = adaptee;
    }
