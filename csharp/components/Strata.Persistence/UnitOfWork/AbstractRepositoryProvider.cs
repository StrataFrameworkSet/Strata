...
namespace Strata.Persistence.UnitOfWork
{
        ...
        where T:class
    {
        ...
        //////////////////////////////////////////////////////////////////////
        /// <summary>
        /// <see cref="IRepositoryProvider<K,T>.GetNamedQuery(String)"/>
        /// </summary>
        /// 
        ...
        //////////////////////////////////////////////////////////////////////
        /// <summary>
        /// <see cref="IRepositoryProvider<K,T>.HasNamedQuery(String)"/>
        /// </summary>
        /// 
        public bool 
        ...
        /// 
        protected abstract T
        DoGetEntityByPredicate(Expression<Func<T, bool>> predicate);
        ...
        DoGetEntitiesByPredicate(Expression<Func<T, bool>> predicate);
        ...
        /// 
        protected abstract INamedQuery<T> 
        ...
        /// 
        protected abstract bool
        DoHasEntitiesByPredicate(Expression<Func<T, bool>> predicate);
