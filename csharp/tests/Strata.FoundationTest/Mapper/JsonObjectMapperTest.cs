...
namespace Strata.Foundation.Mapper
{
    ...
    class JsonObjectMapperTest
    {
        ...
        TestToPayload()
        {
            IFooBar source = new FooBar(new Foo("test"));
            string expected = "{\"$type\":\"Strata.Foundation.Injection.FooBar, Strata.FoundationTest\",\"Foo\":{\"$type\":\"Strata.Foundation.Injection.Foo, Strata.FoundationTest\",\"FooName\":\"test\"},\"Bar\":null,\"Baz\":null}";
