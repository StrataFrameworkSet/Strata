// ##########################################################################
// # File Name:	DiagnosticException.java
// #
...
/**
 * Indicates problems or errors uncovered during a diagnostic check.
 * 
 * @author 		
 *     Sapientia Systems 
 * @conventions	
	...
	extends Exception
{
	...
	/************************************************************************
	 * Creates a new DiagnosticException. 
	 *
	 */
	public 
	DiagnosticException()
	 ...
	 */
	public 
	DiagnosticException(String msg,Throwable e)
	{
		super( msg,e );
	}
	 ...
	 */
	public 
	DiagnosticException(Throwable e)
	{
		super( e );
	}
